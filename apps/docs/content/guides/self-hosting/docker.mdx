...
optional but can be very helpful if you find writing SQL challenging. You can easily get your API key [here](https://platform.openai.com/docs/quickstart#create-and-export-an-api-key://platform.openai.com/api-keys).
<CH.Code>
